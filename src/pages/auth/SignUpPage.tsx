...
import CustomCheckBox from '@/components/website/customCheckBox/CustomCheckBox';
...
const SignUpPage = () => {
  ...
  return (
    <div className='flex flex-col sm:flex-row gap-6'>
      <div className='p-10 sm:p-0 login-img sm:w-[50%] h-[100%]'>
      ...
      <div className='login-cred sm:w-[50%] flex items-center '>
        <div className='w-[70%] flex flex-col m-auto gap-4'>
          ...
          <CustomInput UserInput='Email' setInput={setMail} />
          <CustomCheckBox CheckBoxMessage='Send me special offers, personalized recommendations and learning tips.' />
          <Link
            to='/course'
            className={cn(
              buttonVariants({
