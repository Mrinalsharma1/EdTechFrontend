...
const CarouselFunction: React.FC = () => {
  return (
    <section className='w-full   md:px-6 py-10      bg-[rgba(231,228,226,0.315)] min-h-[450px]  mt-10 overflow-hidden'>
      ...
      <div className='px-0'>
        <Carousel opts={{ align: 'start', loop: false }}>
          ...
          <CarouselContent className='flex gap-4  overflow-x-auto sm:overflow-x-visible snap-x snap-mandatory scrollbar-hide'>
            {/* CARD 1 */}
